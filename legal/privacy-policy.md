...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to yoursite.
...
- __Website__ refers to yoursite, accessible from yoursite.com
...
We do not currently collect emails from users, but we reserve the right to implement this feature anytime in the near and distant furture.
...
- __Flash Cookies.__ Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available at _______-
